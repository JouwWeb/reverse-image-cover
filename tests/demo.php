...
<?php foreach ($fixtures as $fixture):?>
  ...
  <div style="position: relative;">
    ...
    <div style="opacity: 0.6; margin: 10px; float: left; width: <?=$fixture[1][0]?>px; height: <?=$fixture[1][1]?>px; background-image: url(image.php?width=<?=$fixture[2][0]?>&height=<?=$fixture[2][1]?>&crop=<?=implode(',', $fixture[3])?>&bust=<?=time()?>); background-size: cover; background-position: 50% 50%"><span style="background-color: white;">fixture</span></div>
